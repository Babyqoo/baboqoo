 ...
 * Start up Geth's built-in interactive [JavaScript console](https://github.com/baboqoo/go-baboqoo/wiki/JavaScript-Console),
   ...
   as well as Geth's own [management APIs](https://github.com/baboqoo/go-baboqoo/wiki/Management-APIs).
...
[Geth specific APIs](https://github.com/baboqoo/go-baboqoo/wiki/Management-APIs)). These can be
