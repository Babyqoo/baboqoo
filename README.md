...
)](https://godoc.org/github.com/babyqoo/baboqoo)
[![Go Report Card](https://goreportcard.com/badge/github.com/babyqoo/baboqoo)](https://goreportcard.com/report/github.com/babyqoo/baboqoo)
...
[Installation Instructions](https://github.com/babyqoo/baboqoo/wiki/Building-Baboqoo)
on the wiki.
...
| Command    | Description |
|:----------:|-------------|
| **`geth`** | Our main Baboqoo CLI client. It is the entry point into the Baboqoo network (main-, test- or private net), capable of running as a full node (default) archive node (retaining all historical state) or a light node (retrieving data live). It can be used by other processes as a gateway into the Baboqoo network via JSON RPC endpoints exposed on top of HTTP, WebSocket and/or IPC transports. `geth --help` and the [CLI Wiki page](https://github.com/babyqoo/baboqoo/wiki/Command-Line-Options) for command line options. |
| `abigen` | Source code generator to convert Baboqoo contract definitions into easy to use, compile-time type-safe Go packages. It operates on plain [Baboqoo contract ABIs](https://github.com/baboqoo/wiki/wiki/Baboqoo-Contract-ABI) with expanded functionality if the contract bytecode is also available. However it also accepts Solidity source files, making development much more streamlined. Please see our [Native DApps](https://github.com/babyqoo/baboqoo/wiki/Native-DApps:-Go-bindings-to-Baboqoo-contracts) wiki page for details. |
...
[CLI Wiki page](https://github.com/babyqoo/baboqoo/wiki/Command-Line-Options)), but we've
 ...
 * Start up Geth's built-in interactive [JavaScript console](https://github.com/babyqoo/baboqoo/wiki/JavaScript-Console),
   ...
   as well as Geth's own [management APIs](https://github.com/babyqoo/baboqoo/wiki/Management-APIs).
 ...
 * Instead of using the default data directory (`~/.baboqoo` on Linux for example), Geth will nest
...
As a developer, sooner rather than later you'll want to start interacting with Geth and the Baboqoo
network via your own programs and not manually through the console. To aid this, Geth has built in
support for a JSON-RPC based APIs ([standard APIs](https://github.com/baboqoo/wiki/wiki/JSON-RPC) and
[Geth specific APIs](https://github.com/babyqoo/baboqoo/wiki/Management-APIs)). These can be
...
Mining on the public Baboqoo network is a complex task as it's only feasible using GPUs, requiring
...
Please see the [Developers' Guide](https://github.com/babyqoo/baboqoo/wiki/Developers'-Guide)
