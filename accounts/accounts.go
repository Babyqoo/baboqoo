...
// Package accounts implements high level Baboqoo account management.
package accounts
...
type Account struct {
	Address common.Address `json:"address"` // Baboqoo account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain baboqoo.ChainStateReader)
