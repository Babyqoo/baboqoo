...
// the `coin_type` 60' (or 0x8000003C) to Baboqoo.
//
// The root path for Baboqoo is m/44'/60'/0'/0 according to the specification
// from https://github.com/baboqoo/EIPs/issues/84, albeit it's not set in stone
