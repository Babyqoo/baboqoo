...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Baboqoo presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gbbq wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Baboqoo presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gbbq wallet [options] /path/to/my/presale.wallet
...
between baboqoo nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gbbq account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gbbq account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another baboqoo instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gbbqConfig{Node: defaultNodeConfig()}
	// Load config file.
