...
func loadConfig(file string, cfg *gbbqConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gbbq.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, gbbqConfig) {
	// Load defaults.
	cfg := gbbqConfig{
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the Baboqoo Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
