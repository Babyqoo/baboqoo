...
// C++ Baboqoo implementation.
type cppBaboqooGenesisSpec struct {
	...
	Accounts map[common.Address]*cppBaboqooGenesisSpecAccount `json:"accounts"`
}

// cppBaboqooGenesisSpecAccount is the prefunded genesis account and/or precompiled
// contract definition.
type cppBaboqooGenesisSpecAccount struct {
	Balance     *hexutil.Big                   `json:"balance"`
	Nonce       uint64                         `json:"nonce,omitempty"`
	Precompiled *cppBaboqooGenesisSpecBuiltin `json:"precompiled,omitempty"`
}

// cppBaboqooGenesisSpecBuiltin is the precompiled contract definition.
type cppBaboqooGenesisSpecBuiltin struct {
	Name          string                               `json:"name,omitempty"`
	StartingBlock hexutil.Uint64                       `json:"startingBlock,omitempty"`
	Linear        *cppBaboqooGenesisSpecLinearPricing `json:"linear,omitempty"`
}

type cppBaboqooGenesisSpecLinearPricing struct {
...
func newCppBaboqooGenesisSpec(network string, genesis *core.Genesis) (*cppBaboqooGenesisSpec, error) {
	...
	spec.Accounts = make(map[common.Address]*cppBaboqooGenesisSpecAccount)
	for address, account := range genesis.Alloc {
		spec.Accounts[address] = &cppBaboqooGenesisSpecAccount{
			Balance: (*hexutil.Big)(account.Balance),
			Nonce:   account.Nonce,
		}
	}
	spec.Accounts[common.BytesToAddress([]byte{1})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
		Name: "ecrecover", Linear: &cppBaboqooGenesisSpecLinearPricing{Base: 3000},
	}
	spec.Accounts[common.BytesToAddress([]byte{2})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
		Name: "sha256", Linear: &cppBaboqooGenesisSpecLinearPricing{Base: 60, Word: 12},
	}
	spec.Accounts[common.BytesToAddress([]byte{3})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
		Name: "ripemd160", Linear: &cppBaboqooGenesisSpecLinearPricing{Base: 600, Word: 120},
	}
	spec.Accounts[common.BytesToAddress([]byte{4})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
		Name: "identity", Linear: &cppBaboqooGenesisSpecLinearPricing{Base: 15, Word: 3},
	}
	if genesis.Config.ByzantiumBlock != nil {
		spec.Accounts[common.BytesToAddress([]byte{5})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
			Name: "modexp", StartingBlock: (hexutil.Uint64)(genesis.Config.ByzantiumBlock.Uint64()),
		}
		spec.Accounts[common.BytesToAddress([]byte{6})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
			Name: "alt_bn128_G1_add", StartingBlock: (hexutil.Uint64)(genesis.Config.ByzantiumBlock.Uint64()), Linear: &cppBaboqooGenesisSpecLinearPricing{Base: 500},
		}
		spec.Accounts[common.BytesToAddress([]byte{7})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
			Name: "alt_bn128_G1_mul", StartingBlock: (hexutil.Uint64)(genesis.Config.ByzantiumBlock.Uint64()), Linear: &cppBaboqooGenesisSpecLinearPricing{Base: 40000},
		}
		spec.Accounts[common.BytesToAddress([]byte{8})].Precompiled = &cppBaboqooGenesisSpecBuiltin{
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	spec.Genesis.Seal.Baboqoo.Nonce = (hexutil.Bytes)(make([]byte, 8))
	binary.LittleEndian.PutUint64(spec.Genesis.Seal.Baboqoo.Nonce[:], genesis.Nonce)

	spec.Genesis.Seal.Baboqoo.MixHash = (hexutil.Bytes)(genesis.Mixhash[:])
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
// pyBaboqooGenesisSpec represents the genesis specification format used by the
// Python Baboqoo implementation.
type pyBaboqooGenesisSpec struct {
	Nonce      hexutil.Bytes     `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
