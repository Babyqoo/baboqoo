...
type wizard struct {
	...
	services map[string][]string   // Baboqoo services known to be running on servers
...
// converts it to an Baboqoo address. If an empty line is entered, the default
// value is returned.
