...
// setting up a new or managing an existing Baboqoo private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Baboqoo private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Baboqoo network down to  |")
	...
	log.Info("Administering Baboqoo network", "name", w.network)
