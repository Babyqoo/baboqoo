...
import (
	...
	"github.com/babyqoo/baboqoo/common/fdlimit"
	...
	"github.com/babyqoo/baboqoo/dashboard"
...
// for Gbbq and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gbbq account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// RegisterEthService adds an Baboqoo client to the stack.
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the Baboqoo service: %v", err)
	}
}
...
// RegisterEthStatsService configures the Baboqoo Stats daemon and adds it to
// th egiven node.
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		// Retrieve both eth and les services
		var ethServ *eth.Baboqoo
		ctx.Service(&ethServ)
		...
		Fatalf("Failed to register the Baboqoo Stats service: %v", err)
	}
}
...
// new format.
//
// e.g. gbbq account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gbbq --keystore /tmp/mykeystore --lightkdf account new
//
