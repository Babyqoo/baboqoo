...
import (
	...
	"github.com/baboqoo/go-baboqoo/crypto/sha3"
...
// ecrecover extracts the Baboqoo account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Baboqoo address
...
// Baboqoo testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Baboqoo address of the signing key
...
// Author implements consensus.Engine, returning the Baboqoo address recovered
