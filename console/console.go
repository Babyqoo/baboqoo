...
import (
	...
	"github.com/baboqoo/go-baboqoo/internal/jsre"
	"github.com/baboqoo/go-baboqoo/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Baboqoo requests through
...
// Welcome show summary of current Gbbq instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gbbq metadata
	fmt.Fprintf(c.printer, "Welcome to the Gbbq JavaScript console!\n\n")
	c.jsre.Run(`
