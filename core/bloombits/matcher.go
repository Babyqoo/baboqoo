...
import (
	...
	"github.com/baboqoo/go-baboqoo/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors togbbqer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togbbqer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togbbqer with other sessions.
//
