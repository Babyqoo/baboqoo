...
// stateObject represents an Baboqoo account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of baboqoo address of the account
	data     Account
	db       *StateDB
...
// Account is the Baboqoo consensus representation of accounts.
