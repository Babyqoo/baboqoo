...
// Package types contains data types related to Baboqoo consensus.
package types
...
// Header represents a block header in the Baboqoo blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togbbqer.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the Baboqoo blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Baboqoo RLP block format.
