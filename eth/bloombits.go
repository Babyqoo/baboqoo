...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Baboqoo
...
func (eth *Baboqoo) startBloomHandlers() {
...
// for the Baboqoo header bloom filters, permitting blazing fast filtering.
