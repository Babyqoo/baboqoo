...
// Syncing provides information when this nodes starts synchronising with the Baboqoo network and when it's finished.
...
type SyncingResult struct {
	...
	Status  baboqoo.SyncProgress `json:"status"`
}
