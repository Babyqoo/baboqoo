...
import (
	...
	"github.com/baboqoo/go-baboqoo/common/mclock"
...
// Service implements an Baboqoo netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Baboqoo      // Full Baboqoo service if monitoring a full node
	les    *les.LightBaboqoo // Light Baboqoo service if monitoring a light node
...
func New(url string, ethServ *eth.Baboqoo, lesServ *les.LightBaboqoo) (*Service, error) {
