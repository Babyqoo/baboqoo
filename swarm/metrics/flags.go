...
import (
	...
	gbbqmetrics "github.com/baboqoo/go-baboqoo/metrics"
	"github.com/baboqoo/go-baboqoo/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if gbbqmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(gbbqmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
