...
// Whisper represents a dark communication interface through the Baboqoo
...
// New creates a Whisper client ready to communicate through the Baboqoo P2P network.
